          ...
          <div class="reg-box">
            <form>
              <div class="">
                ...
                <p>This serves as the identification form to determine whether you are entitled to the exclusivity of this website as a previlege to DYCIans.</p>
                <div class="choices3">
                  ...
                  <div <?php echo (form_error('graduation') == '') ? '' : ' class="yes_error"'; ?> class="required-red form-group">
                      <?php echo form_label('Year of Graduation:','graduation'); ?>
                    <?php echo form_error('graduation','<div class="error-red">', '</div>'); ?>
